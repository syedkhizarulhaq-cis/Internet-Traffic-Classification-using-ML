...
data.drop(columns=['Flow.ID', 'Source.IP', 'Destination.IP', 'Protocol','Timestamp','Fwd.Packet.Length.Max', 'Fwd.Packet.Length.Min',
                  'Bwd.Packet.Length.Max', 'Bwd.Packet.Length.Min','Flow.IAT.Max','Flow.IAT.Min','Fwd.IAT.Max', 'Fwd.IAT.Min','Bwd.IAT.Max', 'Bwd.IAT.Min',
                 'Fwd.Header.Length.1','Label','L7Protocol','Bwd.Avg.Bulk.Rate','Bwd.Avg.Packets.Bulk','Bwd.Avg.Bytes.Bulk','CWE.Flag.Count','Fwd.Avg.Bytes.Bulk',
